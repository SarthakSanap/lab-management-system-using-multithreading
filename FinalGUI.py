        ...
        if PC_BGcolor!='SystemButtonFace':
            if self.SL_PC_Dict[Pc]['bd'] == 3:
                ...
                if Side == 'Left':
                    ...
                    # place small buttons for USD and Browser one below the other right side of the PC
                    # self.SL_PCs_BrowserPlacing[Pc].place(x=int(PC_X+72*ratioWidth), y=int(PC_Y-10*ratioHeight*ratioHeight+10), width=int(20*ratioWidth), height=int(25*ratioHeight))
                    # self.SL_PCs_USBPlacing[Pc].place(x=int(PC_X+72*ratioWidth), y=int(PC_Y-10*ratioHeight*ratioHeight+35), width=int(20*ratioWidth), height=int(25*ratioHeight))
